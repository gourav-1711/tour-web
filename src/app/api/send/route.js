...
export async function POST(req) {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      subject: `🚗 New ${
        body.type === "local_trip" ? "Local Trip" : "Tour"
      } Booking Request${
        body.city && body.state ? ` - ${body.state}, ${body.city}` : ""
      }`,
      text: `
        New ${
          body.type === "local_trip" ? "Local Trip" : "Tour"
        ...
        Booking Details:
        ${
          body.type === "local_trip"
            ? `
        - Trip Type: ${body.tripType || "Not specified"}
        - Date & Time: ${
          body.dateTime
            ? new Date(body.dateTime).toLocaleString()
            : "Not specified"
        }
        `
            : `
        - Destination: ${body.city || "Not specified"}, ${
                body.state || "Not specified"
              }
        - Start Date: ${
          body.startDate
        ...
        <head>
            ...
            <style>
                ...
                .header {
                    background: ${
                      body.type === "local_trip"
                        ? "linear-gradient(135deg, #ff7b7b 0%, #ff9a56 100%)"
                ...
                .info-item {
                    ...
                    border-left: 4px solid ${
                      body.type === "local_trip" ? "#ff7b7b" : "#667eea"
                    };
                }
                ...
                .highlight {
                    background: ${
                      body.type === "local_trip"
                        ? "linear-gradient(135deg, #ffb3b3 0%, #ffd4a3 100%)"
                ...
                .priority-banner {
                    background: ${
                      body.type === "local_trip" ? "#ff6b6b" : "#667eea"
                    };
                    color: white;
                    padding: 10px;
                    text-align: center;
                ...
                <div class="content">
                    ...
                    <div class="section">
                        ...
                        <div class="call-button-container">
                            <p style="margin: 0 0 10px 0; color: #25d366; font-weight: 600;">📞 Contact Customer Directly</p>
                            <a href="tel:${body.mobile}" class="call-button">
                                📱 Call ${body.mobile}
                            </a>
                        </div>
                        `
